			...
			<div class="cart_table">
							...
							<table class="Table" cellpadding="3" cellspacing="0" width="100%">
								<tbody>
									...
									<c:forEach items="${shopCars}" var="shopCar">
											...
											<td class="align_Left" width="52%">${shopCar.article.title}</td>
											<td width="15%"><span class="price">￥<fmt:formatNumber value="${shopCar.article.discountPrice}" pattern="0.00"></fmt:formatNumber>&nbsp;&nbsp;(${shopCar.article.discount}折)</span></td>
											<td width="5%">￥0.00</td>
											<td width="5%">￥<fmt:formatNumber value="${shopCar.article.discountPrice * shopCar.buyNum}" pattern="0.00"></fmt:formatNumber></td>
											<td width="8%">${shopCar.article.storage}</td>
											<td width="10%">${shopCar.buyNum}</td>
										</tr>
				...
				<div id="ware_info">
					...
					<div class="middle">
						<!--订单信息-->
						<ul id="part_info">
							<li class="info1" style="padding-bottom: 5px">商品金额：<fmt:formatNumber value="${totalPrice}" pattern="0.00"></fmt:formatNumber>元 +
									...
									<tbody>
										<tr>
											...
											<td style="text-align: right; font-size: 15px;"><b>应付总额：<font
													color="red">￥<fmt:formatNumber value="${totalPrice}" pattern="0.00"></fmt:formatNumber></font> 元
											</b>
							...
							<tbody>
								<tr>
									...
									<td style="width: 100px; padding: 0pt;">
										<!-- 确定订单 -->
										<form action="${ctx}/saveOrder.do" method="post" id="orderform">
